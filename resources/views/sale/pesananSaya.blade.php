                                        ...
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{$id}}" aria-expanded="true" aria-controls="collapseOne{{$id}}">
                                            ...
                                            @else
                                                ...
                                                @elseif ($s->buktiPembayaran && $s->status == 2)
                                                    <span class="badge badge-warning">Konfirmasi Barang</span>
                                                @elseif ($s->buktiPembayaran && $s->status == 3)
                                                ...
                                                <tfoot align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            ...
                                                            @elseif ($s->status == 1)
                                                                <button class="btn btn-dark">Pending Konfirmasi Pembayaran</button>
